...
namespace MyImageLib
{
    ...
    {
        public WriteableBitmap CreateNewConvertedImage(BitmapImage loadImage)
        {
            ...
            writeImg = CreateNewEmptyImage(width, height, out rect);
            writeImg.WritePixels(rect, ToMainColors(loadImageByteArr), nStride, 0);
            return writeImg;
        }

        public WriteableBitmap CreateNewEmptyImage(int width, int height, out Int32Rect rect)
        {
            WriteableBitmap emptyImg = new WriteableBitmap(width, height, 96, 96, PixelFormats.Bgr32, null);
        ...
        public WriteableBitmap ToMainColorsOldVer(byte[] pixelOrgArr, int imageWidth, int imageHeight)
        {
            ...
            pixelOrgArr = ToMainColors(pixelOrgArr);
